...
public class ShooterTuner extends Tele {
    ...
    private double p = 0; // Proportional Gain
    private double f = 0; // Feedforward
    ...
    public void initTele() {
        ...
        gpA.onClick(Button.DPAD_UP,   () -> p += 1.0);
        gpA.onClick(Button.DPAD_DOWN, () -> p -= 1.0);
        gpA.onClick(Button.DPAD_LEFT,   () -> f += 1.0);
        gpA.onClick(Button.DPAD_RIGHT, () -> f -= 1.0);
